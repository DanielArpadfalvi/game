...
**Phaser 3 + TypeScript + Vite** motorra építve. Egyjátékos.
...
src/
  ...
  data.ts               # hősök, skillshotok, balansz
  ...
  scenes/
    ...
    MenuScene.ts
    SelectScene.ts      # hősválasztás
    GameScene.ts        # játékmenet (mozgás, skillshotok, ütközés)
    UIScene.ts          # HUD
